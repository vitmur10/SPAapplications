    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_info', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='Сomment.clientinfo')),
                ('parent_comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies_to', to='Сomment.comment')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Сomment.post')),
            ],
        ),
    ]
